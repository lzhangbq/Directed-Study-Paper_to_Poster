...
import argparse
import torch
from dataset import JSONLayout, PosterLayout
...
if __name__ == "__main__":
    ...
    if pretrained:
        ...
        train_dataset = PosterLayout(args.train_json)
        valid_dataset = PosterLayout(args.val_json, max_length=train_dataset.max_length)
